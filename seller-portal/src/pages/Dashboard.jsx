...
import { 
  Smartphone, Signal, Battery, Activity, Clock, 
  Search, ExternalLink, RefreshCw, RefreshCcw, Smartphone as PhoneIcon,
  CheckCircle2, AlertCircle, XCircle, Info, Ticket, HelpCircle,
  Zap, LogOut, ArrowUpRight, Leaf, ChevronRight,
  BatteryCharging, Wifi, ShoppingCart, TrendingUp, History, X, Phone
} from 'lucide-react';
      ...
      <PurchaseModal 
        ...
        onConfirm={(targetPhone) => {
          handleIssueCommand('PURCHASE_OFFER', {
            ...
            isMultiSession: selectedOffer.isMultiSession || false,
